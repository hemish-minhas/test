        ...
        <ul class="navbar-nav ml-auto">
          <li class="nav-item dropdown">
            ...
            <a class="dropdown-item" href="../uoft/dashboard_uoft.php">University of Toronto</a>
						...
						<a class="dropdown-item" href="./dashboard_uofm.php">University of Manitoba</a>
            </div>
          </li>
          <li class="nav-item">
  ...
  <div class="container-fluid padding">
    <div class="welcome text-left">
      <div class="col-0" style="display: flex; align-items: flex-end">
        <img class="img-fluid" style="float: left" src="logo_uofm.png" alt="uofm logo" />
        <h1 class="display-4">
      ...
      <div class="col-auto">
        <table class="table table-hover table-responsive">
          ...
          <tbody>
            ...
            $sql = "SELECT * FROM manitoba WHERE university_name = 'University of Manitoba' AND cases != 0";
